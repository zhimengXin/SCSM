...
############################################################################################################################
        ...
        if cfg.MODEL.BACKBONE.FREEZESCSM:
            scsm_modules = [
            # self.lateral_conv_in,
            # self.lateral_conv_out,
            self.encoder,
            ...
            for i in range(3):
                scsm_modules.append(getattr(self, f'encoder_{i}'))
                scsm_modules.append(getattr(self, f'mamba_block_{i}'))
            for module in scsm_modules:
